...
public class CameraShake : MonoBehaviour {
	...
	IEnumerator Shake() {
		...
		while (shakeDuration > 0.01f) {
			...
			rotationAmount = rotationAmount + m_defaultRotation.eulerAngles;
		...
		transform.localRotation = m_defaultRotation;//Set the local rotation to 0 when done, just to get rid of any fudging stuff.
		isRunning = false;
	}
